...
class merge(): 
  ...
  def main(url_list):
      ...
      for index in range(len(url_list)):
          ...
          # 检查是否发生订阅内容解析错误
          if content == 'Url 解析错误' or content == '订阅内容解析错误':
              print(f'Writing error of {remark} to {ids:0>2d}.txt because of Url 解析错误 or 订阅内容解析错误\n')
              continue  # 跳过这次合并，避免错误内容影响正常节点
      ...
      # 合并节点内容
      print('Merging nodes...\n')
      content_raw = ''.join(content_list)  # 拼接所有有效的内容
